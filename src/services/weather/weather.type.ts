export interface WeatherResponse {
  ...
  forecast: WeatherReponseForecast;
}
...
interface WeatherReponseForecast {
...
interface ForecastDay {
  ...
  astro: WeatherReponseAstro;
  hour: WeatherResponseHour[];
}

interface WeatherResponseDay {
  maxtemp_c: number;
  maxtemp_f: number;
  mintemp_c: number;
  mintemp_f: number;
